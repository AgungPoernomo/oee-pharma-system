  ...
  return (
    <div className="min-h-screen bg-white p-8 text-black font-sans">
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-4">
          <h1 className="text-2xl font-black tracking-wider uppercase">OEE Line 4 - Zone F</h1>
        </div>
        ...
        <div className="mb-4">
          <h2 className="text-2xl font-black tracking-wider uppercase">Downtime Line 4 - Zone F</h2>
        </div>
