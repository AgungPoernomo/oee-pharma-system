...
const calculateZoneMetrics = (volume) => {
    ...
    else if (volume === '500 ML') { speed = 8000; teoriBatch = 11538; }
    else if (volume === '1000 ML') { speed = 8000; teoriBatch = 11538; }
    else if (volume === '100 ML PAR') { speed = 8000; teoriBatch = 27522; }
...
const DailyOnesheet = () => {
    ...
    const executeSearch = async () => {
        ...
        try {
            const res = await fetchOnesheetData(inputDate, line1User);
