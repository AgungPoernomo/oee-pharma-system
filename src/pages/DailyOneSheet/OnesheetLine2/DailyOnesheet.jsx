...
const DailyOnesheet = () => {
    const { user } = useAuth();
    const line2User = useMemo(() => ({ ...(user || {}), line: "2", plant: "1" }), [user]);
    ...
    const executeSearch = async () => {
        ...
        try {
            const res = await fetchOnesheetData(inputDate, line2User);
        ...
        <div className="min-h-screen bg-gray-50 text-black font-sans p-4 md:p-8 pb-32">
            ...
            <div className="w-full overflow-x-auto pb-10">
                ...
                >
                    ...
                    <div className="border-4 bg-green-300 border-black pb-4 mb-8 text-center flex flex-col items-center">
