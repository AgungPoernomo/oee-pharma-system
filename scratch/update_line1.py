...
def update_inputc():
    with open('src/pages/Inputdata/DataLine1/INPUTC.jsx', 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    with open('src/pages/Inputdata/DataLine1/INPUTC.jsx', 'w', encoding='utf-8') as f:
        f.write(content)
        
update_inputc()
print('DONE INPUTC phase 1')
